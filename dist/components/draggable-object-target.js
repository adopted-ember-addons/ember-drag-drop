...
var draggableObjectTarget = setComponentTemplate(TEMPLATE, Component.extend(Droppable, {
  ...
  handlePayload(payload, event) {
    let obj = this.get('coordinator').getObject(payload, {
      target: this
    });
    this.get('action')(obj, {
      target: this,
...
export { draggableObjectTarget as default };
//# sourceMappingURL=draggable-object-target.js.map
